<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContactForm.ascx.cs" Inherits="BegASPNET2.Controls.ContactForm" %>

<%--Style design for the contact form--%>
<style type="text/css">
    .auto-style1 {
        width: 100%;
    }
...
<%--script to making the page run without to much flicking--%>
<script>
  $(function ()
  {
